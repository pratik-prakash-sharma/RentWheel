...
const Testimonial = () => {
    ...
    return (
        ...
        <div className='py-28 px-6 md:px-16 mg:px-24 xl:px-44 flex flex-col justify-center items-center'>

            <Title title={'What Our Coustomers Say'} subTitle={'Discover why discerning travelers choose StayVenture for their luxury accomodations arround the world'}
            />

            <div className="grid grid-col-1 sm:grid-col-2 lg:grid-cols-3 gap-8 mt-18">
