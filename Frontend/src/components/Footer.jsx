...
const Footer = () => {
    return (
        <motion.footer
            ...
            className="flex items-center gap-4 mt-8 text-indigo-500">
            ...
            className="mt-8 text-center">Copyright © 2025 <a href="https://prebuiltui.com">PrebuiltUI</a>. All rights reservered.</motion.p>
        </motion.footer>
    )
}
