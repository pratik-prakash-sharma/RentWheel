...
const MyBookings = () => {
    ...
    return (
        <motion.div
            ...
            className='px-6 md:px-16 lg:px-24 xl:px-32 2xl:px-48 t-16 text-sm max-w-7xl'>
            ...
            <div>
                ...
                '>
                            <div className='rounded-md overflow-hidden mb-3'>
                                <img src={booking.car.image} alt="" className='w-full h-auto asprct-video object-cover' />
                            </div>
                            <p className='text-lg font-medium mt-2
                    '>{booking.car.brand} {booking.car.model}</p>
