...
const ManageBooking = () => {
  ...
  return (
     <div className='px-4 py-10 md:px-10 w-full'>
      <Title title={'Manage Bookings'} subTitle={'Track all customer bookings, approve or cancel requests, and manage booking statueses.'} />
        ...
        <table className='w-full border-collapse text-left text-sm text-gray-600'>
          ...
          <tbody>
            {bookings.map((booking, index) => {
              return <tr key={index} className='border-t border-borderColor text-gray-500'>
