...
const Dashboard = () => {
  ...
  return (
    <div className='px-4 pt-10 md:px-10 flex-1'>
      <Title title={'Admin Dashboard'} subTitle={'Monitor overall platform performance including total cars, bookigs, revenue, and recent activities'} />
      ...
      <div className='flex flex-wrap items-start gap-6 mb-8 w-full'>
        ...
        <div className='p-4 md:p-6 border border-borderColor rounded-md max-w-lg w-full'>
          ...
          <p className='text-gray-500'>Latest cusomer bookings</p>
        ...
        {/* Monthly revenue */}
        <div className='p-4 md-p-6 mb-5 border border-borderColor rounded-md w-full md:max-w-xs'>
