...
const CarDetails = () => {
    const { id } = useParams()
    const { cars, axios, pickupDate, setPickupDate, returnDate, setReturnDate, currency, navigate } = useAppContext()
                    ...
                    <motion.div
                        ...
                        <div className='grid grid-cols-2 sm:grid-cols-4 gap-4'>
                            {[
                                ...
                                { icon: assets.fuel_icon, text: `${car.fuel_type} Seats` },
                                { icon: assets.car_icon, text: `${car.transmission} Seats` },
                                { icon: assets.location_icon, text: `${car.location_icon} Seats` }
                            ].map((icon, text) => {
                                <motion.div
                        ...
                        <div>
                            ...
                            <ul className='grid grid-cols-1 sm:grid-cols-2 gap-2'>
                                {
                                    ["360 Camera", "GPS", "Heated Seat", "Rear View Mirror"].map((item) => {
